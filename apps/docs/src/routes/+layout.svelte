<script lang="ts">
	...
	import { loadTheme, setTheme, themeState } from '@anthropic-public/ui-svelte';
...
<svelte:head>
	<title>UI Svelte - Component Library</title>
...
<div class="docs-layout" class:sidebar-open={sidebarOpen}>
	...
	<header class="docs-header">
		<div class="header-left">
			...
			<a href="/" class="logo">
				<span class="logo-text">UI Svelte</span>
			</a>
		</div>
		<div class="header-right">
			<a href="https://github.com/anthropics/ui-svelte" target="_blank" rel="noopener" class="header-link" aria-label="GitHub">
