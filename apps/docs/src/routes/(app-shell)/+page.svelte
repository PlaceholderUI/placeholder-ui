...
<style>
	...
	.hero-subtitle {
		...
		max-width: 600px;
		margin: 0 auto var(--cui-spacing-6);
	...
	.features h2 {
		text-align: center;
		margin-bottom: var(--cui-spacing-8);
	}

	.feature-grid {
		display: grid;
		grid-template-columns: repeat(auto-fit, minmax(280px, 1fr));
		gap: var(--cui-spacing-6);
	}

	.feature-card {
		padding: var(--cui-spacing-6);
		background: var(--cui-color-gray-50);
		border-radius: var(--cui-radius-lg);
		border: 1px solid var(--cui-color-gray-200);
	}
