...
<div class="page-header">
	<h1>Button</h1>
	<p>
		Buttons trigger actions when clicked. They come in multiple variants and
		sizes.
	</p>
</div>
...
<div class="vstack">
	<Paper title="Variants">
		<p class="section-description">
			The library uses a color + style modifier pattern for button
			variants.
		</p>
	...
	<Paper title="With Icons">
		<p class="section-description">
			Add icons to the left or right side of buttons using <code>svg</code
			>
			and <code>rightSvg</code> props.
		</p>
		<div class="button-row">
			<Button svg={iconPlus}>Add Item</Button>
			<Button svg={iconCheck} variant="secondary">Confirm</Button>
			<Button rightSvg={iconArrowRight} variant="primary-outline"
				>Next</Button
			>
	...
	<Paper title="Loading State">
		<p class="section-description">
			Show a loading spinner when an async action is in progress. The
		...
		<table class="props-table">
			...
			<tbody>
				<tr>
					...
					<td
						><a href="/docs/types/button-variant"
							><code>ButtonVariant</code></a
						></td
					>
	...
	<Paper title="Custom Styling">
		<p class="section-description">
			Override button colors using CSS variables. Each variant uses
			internal CSS variables that you can customize.
		</p>
