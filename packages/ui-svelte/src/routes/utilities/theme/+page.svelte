<script lang="ts">
	...
	const bpColumns: Column<BreakpointRow>[] = [
		{ key: 'name', label: 'Name' },
		{ key: 'value', label: 'Value' },
		{ key: 'description', label: 'Description' },
	];

	const bpRows: BreakpointRow[] = $derived([
		{ name: 'sm', value: `${breakpoints.sm}px`, description: 'Small devices (phones)' },
		{ name: 'md', value: `${breakpoints.md}px`, description: 'Medium devices (tablets)' },
		{ name: 'lg', value: `${breakpoints.lg}px`, description: 'Large devices (desktops)' },
		{ name: 'xl', value: `${breakpoints.xl}px`, description: 'Extra large devices' },
		{ name: 'xxl', value: `${breakpoints.xxl}px`, description: 'Wide screens' },
		{ name: 'ultrawide', value: `${breakpoints.ultrawide}px`, description: 'Ultra-wide monitors' },
	]);
</script>
...
// Read current theme
	...
	<Paper title="Breakpoints">
		<Table columns={bpColumns} rows={bpRows} striped hover={false} />
	</Paper>
</div>
