...
<div class="vstack">
	...
	<Paper title="Allow Create">
		<div class="form-grid">
			<Autocomplete
				label="Fruit (with create)"
				bind:value={createValue}
				options={fruitOptions}
				placeholder="Type a fruit or create a new one..."
				allowCreate
			/>
			<div class="value-display">Value: "{createValue}"</div>
		</div>
	</Paper>

	<Paper title="Show No Results Message">
		<div class="form-grid">
			<Autocomplete
				label="With No Results Message"
				options={fruitOptions}
