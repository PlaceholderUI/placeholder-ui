...
export const pages: PageInfo[] = [
	...
	},
	{
		...
		href: '/components/autocomplete-multi',
		description: 'Multi-select text input with autocomplete suggestions',
		keywords: ['autocomplete', 'multi', 'typeahead', 'suggest', 'search', 'tags', 'input'],
		category: 'form'
	},
	{
		label: 'ComboBox',
